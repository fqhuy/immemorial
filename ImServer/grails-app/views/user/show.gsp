	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.shortBio}">
				<li class="fieldcontain">
					<span id="shortBio-label" class="property-label"><g:message code="user.shortBio.label" default="Short Bio" /></span>
					
						<span class="property-value" aria-labelledby="shortBio-label"><g:fieldValue bean="${userInstance}" field="shortBio"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${userInstance?.tweets}">
				<li class="fieldcontain">
					<span id="tweets-label" class="property-label"><g:message code="user.tweets.label" default="Tweets" /></span>
